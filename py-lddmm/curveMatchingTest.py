...
#            end = start + np.random.uniform(0, np.pi)
    ...
    f = CurveMatching(Template=ftemp, Target=ftarg, outputDir=dirOut+'/Development/Results/curveMatching'+model+'LDDMMlargeKernel',param=sm, testGradient=False,
                      regWeight=.1, internalWeight=100.0, maxIter=100000, affine='none', rotWeight=10., transWeight = 10., scaleWeight=100., affineWeight=100.)
...
if __name__=="__main__":
    compute(model='atlasSections', dirOut='/Users/younes')
