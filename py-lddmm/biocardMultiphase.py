...
def compute():
    ...
    outputDir = '/Users/younes/Development/Results/biocardSliding'
    ...
    sm = SurfaceMatchingParam(timeStep=0.1, KparDiff=K1, KparDiffOut=K2, sigmaDist=2.5, sigmaError=1, errorType='current')
