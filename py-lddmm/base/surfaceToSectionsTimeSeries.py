...
class SurfaceToSectionsTimeSeries(SurfaceTimeMatching):
    def __init__(self, Template=None, Target=None, options = None):
        # param=None, times= None, maxIter=1000,
    ...
    def set_template_and_target(self, Template, Target, misc = None): #subsampleTargetSize=-1, select_planes=None):
        if Template is None:
    ...
    def endPointGradient(self, endPoint=None):
        ...
        for k in range(self.nTarg):
            ...
            targGradient /= self.options['sigmaError']**2
